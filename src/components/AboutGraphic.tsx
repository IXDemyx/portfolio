  ...
  return (
    <div className="relative mx-auto flex min-h-97.5 w-full max-w-md items-center justify-center">
      ...
      <div className="relative">
        ...
        <div className="absolute -right-5 -top-5 rounded-full border border-emerald-300 bg-white px-3 py-1.5 font-mono text-xs font-medium text-emerald-700 shadow-md dark:border-emerald-800 dark:bg-slate-900 dark:text-emerald-400">
...
function InfoBadge({ className, icon, label }: InfoBadgeProps) {
  return (
    <div
      className={`absolute flex items-center gap-2 rounded-xl border border-slate-200 bg-white/90 px-3 py-2 shadow-md backdrop-blur transition hover:-translate-y-1 dark:border-slate-700 dark:bg-slate-900/90 ${className}`}
    >
