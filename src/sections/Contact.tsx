        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white px-6 py-12 shadow-sm sm:px-10 lg:px-14 dark:border-(--accent-border) dark:bg-(--bg-secondary)">
            ...
            <div className="relative max-w-3xl">
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl dark:text-(--text-primary)">
                {contact.title[language]}
              </h2>

              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600 dark:text-(--text-secondary)">
